<div class="row m-0 px-3 align-items-center bg-white py-0 py-sm-3" id="adminMediaSelectBoxWrap">
    ...
    <div class="col-sm-auto pb-3 pb-sm-0">
        <a href="#" class="btn btn-dark" role="button" id="bulkSelectFile">Bulk Select</a>
    </div>
</div>
<div class="row m-0 p-3 d-none bg-white" id="adminMediaBulkDestroyWrap">
    <div class="col-6 col-sm-auto">
        <button class="btn btn-dark" id="cancelBulkSelect">Cancel BulkSelect</button>
    </div>
    <div class="col-6 col-sm-auto">
        <form action="{{ route('admin.file.bulkDestroy') }}" method="post" id="bulkDestroyFileForm">
            @csrf
            @method('delete')
