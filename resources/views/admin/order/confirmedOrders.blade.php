	...
	<script>
	   	$(document).ready(function() {
	   		$("#search").keyup(function(event) {
	   			var search = $(this).val();
	   			//alert(search);
	   			$.get('/admin/order/confirmed/search', {'search':search}, function(data){
                    $("tbody").html(data);
                });
	   		});
	   		$("select[name = type]").change(function(){
                var type = $(this).val();
                // alert(type);
                $.get('/admin/order/confirmed/filter', {'type':type}, function(data){
                    $("tbody").html(data);
                })
	        });
	         $("select[name = sort]").change(function(){
                var sort = $(this).val();
                // alert(sort);
                $.get('/admin/order/confirmed/sort', {'sort':sort}, function(data){
                    $("tbody").html(data);
                })
	        });
		});
